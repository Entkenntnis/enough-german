function LoadBar() {
  ...
  var u = {
    ...
    oscillationSize: { type: 'f', value: 0.0004 },
...
LoadBar.prototype.addText = function () {
  ...
  this.loadInfoDiv.innerHTML +=
    'Navigation : Klicke auf das Logo unten rechts zum Blättern<br/>'
...
LoadBar.prototype.update = function () {
  ...
  if (!this.ending) {
    ...
    this.center.material.uniforms.iModelMat.value.getInverse(
      this.center.matrixWorld
    )
...
LoadBar.prototype.updatePercentTexture = function (
  percent,
  canvas,
  ctx,
  texture,
...
LoadBar.prototype.createRingGeo = function (size) {
  ...
  for (var i = 0; i < segments; i++) {
    ...
    var tU = (2 * Math.PI * (i + 0.4)) / segments
