...
var failureLink = 'https://vimeo.com/130835942';
var failureImg = 'icons/albumCover.png';
var failureVideo = '130835942';
...
function Loader(  params ){
  ...
  Loader.prototype = {
    ...
    loadBarAdd: function(){
      ...
      this.loadUpdate( this.numberLoaded / this.numberToLoad );
    ...
    addFailureDialog: function(){
      ...
      this.failureImg = document.createElement( 'div' );
      this.failureImg.innerHTML = string
      ...
      //this.failureDialog.appendChild( string )
    ...
    detectChrome: function(){
        ...
        if(isChromium !== null && isChromium !== undefined && vendorName === "Google Inc.") {
           ...
           this.addFailure( "Non Chrome", "https://www.google.com/chrome/")
        }
